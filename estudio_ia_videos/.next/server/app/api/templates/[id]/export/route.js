"use strict";(()=>{var e={};e.id=7506,e.ids=[7506],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},41780:(e,t,a)=>{a.r(t),a.d(t,{originalPathname:()=>g,patchFetch:()=>$,requestAsyncStorage:()=>c,routeModule:()=>u,serverHooks:()=>m,staticGenerationAsyncStorage:()=>l});var o={};a.r(o),a.d(o,{GET:()=>p});var n=a(49303),r=a(88716),s=a(60670),i=a(87070);let d=[];async function p(e,{params:t}){try{let a,o,n;let{id:r}=t,{searchParams:s}=new URL(e.url),p=s.get("format")||"json",u=d.find(e=>e.id===r);if(!u)return i.NextResponse.json({error:"Template n\xe3o encontrado",success:!1},{status:404});switch(u.downloads+=1,u.metadata.usage.downloads+=1,u.metadata.usage.lastUsed=new Date,p){case"json":a=JSON.stringify(u,null,2),o="application/json",n=`${u.name.replace(/[^a-zA-Z0-9]/g,"_")}.json`;break;case"xml":a=`<?xml version="1.0" encoding="UTF-8"?>
<template>
  <id>${u.id}</id>
